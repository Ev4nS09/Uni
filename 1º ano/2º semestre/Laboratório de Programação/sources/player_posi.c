...
int count_universal(Player *a, int n)
{
  ...
  for(int i = 0; i < n; i++)
    {
      if(strcmp(a[i].posi,"Avançado") != 0 && strcmp(a[i].posi,"Médio") != 0 && strcmp(a[i].posi,"Defesa") != 0 && strcmp(a[i].posi,"Guarda-redes") != 0)
        result++;
    }
    return result;
}
...
int player_sort_posi(Player a)
{  
 int result = 0;
  if(strcmp(a.posi,"Avançado") != 0 && strcmp(a.posi,"Médio") != 0 && strcmp(a.posi,"Defesa") != 0 && strcmp(a.posi,"Guarda-redes") != 0)
    result = 1;
  if(strcmp(a.posi,"Avançado") == 0)
    result = 2;
  if(strcmp(a.posi,"Médio") == 0 )
    result = 3;
  if(strcmp(a.posi,"Defesa") == 0)
    result = 4;
  if(strcmp(a.posi,"Guarda-redes") == 0)
    result = 5;
  return result;
}
...
void player_isort_posi(Player *a, int n)
{
  for (int i = 1; i < n; i++)
  {
    int j = i;
    while (j > 0 && (player_sort_posi(a[j-1]) - player_sort_posi(a[j])) < 0)
    {
