...
// printArray(a);
// a = generateRandomArray(TINY);
// //This test is not ideal because the time of the clone method is included in
// the execution time.
...
// //test 2
// System.out.println(INFO + "testing sort with array of size " + powerOf2 + "
// (a power of 2)");
// a = generateRandomArray(powerOf2);
// MergeInsertionSort.sort(a);
// System.out.println("isSorted: " + Sort.isSorted(a));
// time =
// TemporalAnalysisUtils.getAverageCPUTime(i->generateRandomArray(i),powerOf2,MergeInsertionSort::sort,30);
...
// System.out.println("isSorted: " + Sort.isSorted(a));
// time =
// TemporalAnalysisUtils.getAverageCPUTime(i->generateRandomArray(i),LARGE,MergeInsertionSort::sort,30);
...
// //test1
// //this one I can test by printing the array, because the specification is
// very clear on what to do
// Integer[] example =
// MergeInsertionSort.generateRandomExample(pseudoRandom,20);
// printArray(example);

// //since I want to give some freedom in the way students implement these
// methods, I'm testing them
// //by average number of sorted positions.
// //test2
// System.out.println(INFO + "testing MostlySorted with size " + MEDIUM);
// float avgPercentage =
// getAverageSortedPercentage(MergeInsertionSort::generateMostlySortedExample,MEDIUM,100);
// boolean testResult = withinErrorMargin(avgPercentage, DESIRED_VALUE_1,
// ERROR_MARGIN_1);
// System.out.println("Avg. Sorted Elements " + (DESIRED_VALUE_1 -
// ERROR_MARGIN_1) + " <= " + (DESIRED_VALUE_1 + ERROR_MARGIN_1) + ": " +
// testResult);

// //test3
// System.out.println(INFO + "testing AlmostSorted with size " + BIG);
// avgPercentage =
// getAverageSortedPercentage(MergeInsertionSort::generateAlmostSortedExample,BIG,100);
// testResult = withinErrorMargin(avgPercentage, DESIRED_VALUE_2,
// ERROR_MARGIN_2);
// System.out.println("Avg. Sorted Elements " + (DESIRED_VALUE_2 -
// ERROR_MARGIN_2) + " <= " + (DESIRED_VALUE_2 + ERROR_MARGIN_2) + ": " +
// testResult);
...
// private static boolean withinErrorMargin(float value, float desiredValue,
// float errorMargin)
// {
// return (value <= desiredValue + errorMargin) && (value >= desiredValue -
// errorMargin);
// }

// private static float
// getAverageSortedPercentage(BiFunction<Random,Integer,Integer[]>
// exampleGenerator, int size, int trials)
// {
