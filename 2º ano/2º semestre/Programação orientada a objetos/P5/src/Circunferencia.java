...
public class Circunferencia extends FiguraGeometrica{
    ...
    public boolean segmentIntersects(Segmento segmento){
        ...
        double b = (2 * -this.center.getX()) + (2 * (segmento.getSegmentEquationConstant() -this.center.getY()) * segmento.getSlope());
        double c = Math.pow(this.center.getX(), 2) + Math.pow(segmento.getSegmentEquationConstant() - this.center.getY(), 2) - Math.pow(this.r, 2);
