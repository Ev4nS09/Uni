...
class Segmento{
    ...
    */
     ...
     */
    public double getSegmentEquationConstant(){
    ...
    */
    ...
    public boolean segmentIntersects(Segmento segmentoDeReta){
        ...
        if(denominador == 0 && numeradorU == 0 && numeradorV == 0){   //Os segmentos sao coincidentes
            if(pointBelongSemgnetArea(P3) || pointBelongSemgnetArea(P4)) result = true;
        }
    ...
    */
    ...
    public boolean pointBelongSegment(Ponto intersecao){
        ...
        else return (intersecao.getY() == ((getSlope() * intersecao.getX()) + getSegmentEquationConstant()) && pointBelongSemgnetArea(intersecao));
    }
